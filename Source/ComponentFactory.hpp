...
namespace FeatherVK {
    struct ComponentName {
        ...
        inline static const std::string UIComponent = "UIComponent";
    };
    ...
    public:
        ...
        void InitMap(){
            ...
            componentConstructorMap[ComponentName::UIComponent] = [](const rapidjson::Value& object)->Component*{return new UIComponent(object);};
#ifdef RAY_TRACING
